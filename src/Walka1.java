 ...
 */
public class Walka1 extends Walka{

    ListaPoleKarty sojusznik;
    ListaPoleKarty  przeciwnik;
    Ekran ekran;
    int flaga_przesuwania;
    ...
    Walka1(ListaPoleKarty  sojusznik,ListaPoleKarty  przeciwnik,Ekran ekran)
    {
    ...
    public void obsluga()
    {
        ...
        for(int i=0;i<this.sojusznik.size();i++)
        {
            if(this.sojusznik.listaPoleKarty.get(i).wskaznik==-1)ktory=i;
        }
        if(ktory!=100) {
            this.sojusznik.listaPoleKarty.get(ktory).x = ekran.a;
            this.sojusznik.listaPoleKarty.get(ktory).y = ekran.b;
            ekran.y=0;
            ekran.x=0;
        }
       ...
       if(ktory!=100){
        for(int i=0;i<this.przeciwnik.size();i++)
        {
            ...
            if((this.przeciwnik.listaPoleKarty.get(i).rectangle.contains(this.sojusznik.listaPoleKarty.get(ktory).x,this.sojusznik.listaPoleKarty.get(ktory).y)||this.przeciwnik.listaPoleKarty.get(i).rectangle.contains(this.sojusznik.listaPoleKarty.get(ktory).x+this.sojusznik.listaPoleKarty.get(ktory).szerokosc,this.sojusznik.listaPoleKarty.get(ktory).y))||(this.przeciwnik.listaPoleKarty.get(i).rectangle.contains(this.sojusznik.listaPoleKarty.get(ktory).x,this.sojusznik.listaPoleKarty.get(ktory).y+this.sojusznik.listaPoleKarty.get(ktory).wysokosc)||this.przeciwnik.listaPoleKarty.get(i).rectangle.contains(this.sojusznik.listaPoleKarty.get(ktory).x+this.sojusznik.listaPoleKarty.get(ktory).wysokosc,this.sojusznik.listaPoleKarty.get(ktory).y+this.sojusznik.listaPoleKarty.get(ktory).wysokosc)))
            {
                if(przeciwnik.listaPoleKarty.get(i).wskaznik==-1||flaga_wcisniecia_przeciwnik==0) {
                    if( this.przeciwnik.listaPoleKarty.get(i).wskaznik==2) {
                        this.przeciwnik.listaPoleKarty.get(i).wskaznik=-1;
                ...
                this.sojusznik.listaPoleKarty.get(ktory).wskaznik=2;
            }
        }}
    ...
    public void aktywuj_umiejetnosc(int karta,int przycisk,int wybor)
    {
        ...
        if(tmp_aktywny.listaPoleKarty.get(karta).tab_umiejetnosci.get(przycisk).getStan()==0) {
            switch (indeks) {
                ...
                case 2:
                    tmp_aktywny.listaPoleKarty.get(karta).getKarta().moc *= 2;
                    tmp_aktywny.listaPoleKarty.get(karta).tab_umiejetnosci.get(przycisk).uzyj_umiejetnosci();
                    break;
                case 4:
                    for (int i = 0; i < tmp_aktywny.size(); i++) {
                        if(i!=karta) {
                            tmp_aktywny.listaPoleKarty.get(i).getKarta().hp *= 1.5;
                        }
                    }
                    tmp_aktywny.listaPoleKarty.get(karta).tab_umiejetnosci.get(przycisk).uzyj_umiejetnosci();
                    break;
